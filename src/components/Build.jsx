...
const Build = () => {
  return (
    ...
    <img src="https://edublink.co/images/elamentor-01.png" alt=""  />
    <img src="https://edublink.co/images/elamentor-02.png" className='absolute bottom-[-10%] left-[-10%] max-[600px]:w-40  ' alt=""  /></div>
     <div className=" w-[50%] max-[1080px]:w-full">
        ...
        <div className=" flex flex-wrap justify-between w-[70%]">
            <p className='flex flex-row items-center '> <img src="https://edublink.co/images/icon-1.svg" className='w-10 mt-3' alt=""  /> Drag and Drop Editor</p>
            <p className='flex flex-row items-center'> <img src="https://edublink.co/images/icon-1.svg" className='w-10 mt-3' alt=""  /> Drag and Drop Editor</p>
            <p className='flex flex-row items-center'> <img src="https://edublink.co/images/icon-1.svg" className='w-10 mt-3' alt=""  /> Drag and Drop Editor</p>
            <p className='flex flex-row items-center'> <img src="https://edublink.co/images/icon-1.svg" className='w-10 mt-3' alt=""  /> Drag and Drop Editor</p>
        </div>
