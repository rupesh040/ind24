...
const Zoom = () => {
  return (
    <div className='p-5 max-w-[1280px] mx-auto flex  justify-between max-[1080px]:overflow-hidden relative items-center max-[1080px]:flex-col gap-10'>
        ...
        <img src="https://edublink.co/images/macbook-air-2.webp" alt=""  />
        <img src="https://edublink.co/images/zoom-meeting.webp" className='absolute top-0 right-0 max-[600px]:w-40  ' alt=""  /></div>
