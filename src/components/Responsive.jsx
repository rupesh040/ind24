...
const Responsive = () => {
  return (
        ...
        <div className=" w-[50%] max-[1080px]:w-full">
            ...
            <img src="https://edublink.co/images/gadget.png"  className='my-10' alt=""  />
        </div>
        <div className=" relative">
        <img src="https://edublink.co/images/imac.png" alt=""  />
        <img src="https://edublink.co/images/iphone-1.png" className='absolute bottom-0 right-0 max-[600px]:w-40  ' alt=""  /></div>
